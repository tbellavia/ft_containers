...
namespace ft {
	...
	class vector {
		public:
			...
			typedef ft::vector_::iterator<pointer>					iterator;
			typedef ft::vector_::const_iterator<pointer>			const_iterator;
			typedef ft::vector_::reverse_iterator<pointer>			reverse_iterator;
			typedef ft::vector_::const_reverse_iterator<pointer>	const_reverse_iterator;
		private:
